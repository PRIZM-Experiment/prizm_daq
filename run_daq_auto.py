...
if os.path.exists(path):
    ...
    os.system('python prizm_housekeeping.py -o "antenna","res50","short","noise","res100","open" -a 23,0.05 -r 24,0.05 -s 25,0.05 -n 5,0.05 -R 26,0.05 -O 12,0.05 --reset 18 -m 21 -t 1 -c config_tempsensor.txt')
    exit(0)
